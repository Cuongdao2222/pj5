                        ...
                        <tbody>
                            ...
                            <tr id="row_1208">
                                ...
                                <td>
                                    ...
                                    <div>Giá deal : <b style="color:red;">{{  str_replace(',' ,'.', number_format($val->deal_price))   }}</b> vnd - Giá thường: <b style="color:red;">{{  str_replace(',' ,'.', number_format(intval($product_info->Price)))   }}</b> </div>
