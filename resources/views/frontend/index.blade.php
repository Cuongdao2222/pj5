...
@section('content') 
    ...
    @push('style')
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('css/home.css') }}?ver=31">
        <link rel="stylesheet" type="text/css" href="{{ asset('css/index.css') }}?ver=4">
        <link rel="stylesheet" type="text/css" href="{{ asset('css/homes.css') }}?ver=14">
...
.falling-item:nth-of-type(1) {
    ...
    animation-delay: 6s, .5s;
    font-size: 2.5em;
    background-image: url({{ asset('images/posts/tet') }}/pink_1-min.png)
}
...
.falling-item:nth-of-type(2) {
    ...
    font-size: 1.9em;
    background-image: url({{ asset('images/posts/tet') }}/yellow_2-min.png)
}
...
.falling-item:nth-of-type(3) {
    ...
    animation-delay: 4s, 2s;
    font-size: 2.4em;
    background-image: url({{ asset('images/posts/tet') }}/pink_3-min.png)
}
...
.falling-item:nth-of-type(4) {
    ...
    animation-delay: 3s, 1.5s;
    font-size: 2.1em;
    background-image: url({{ asset('images/posts/tet') }}/yellow_4-min.png)
}
...
.falling-item:nth-of-type(5) {
    ...
    animation-delay: 2s, 2s;
    font-size: 2.3em;
    background-image: url({{ asset('images/posts/tet') }}/pink_5-min.png)
}
...
.falling-item:nth-of-type(6) {
    ...
    animation-delay: 1s, 0s;
    font-size: 2.2em;
    background-image: url({{ asset('images/posts/tet') }}/yellow_6-min.png)
}
.falling-item:nth-of-type(7) {
    left: 70%;
    -webkit-animation-delay: 1s, 0s;
    animation-delay: 1s, 0s;
    font-size: 2.2em;
    background-image: url({{ asset('images/posts/tet') }}/yellow_5-min.png)
}
