...
@section('content') 
    ...
    @push('style')
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('css/home.css') }}?ver=29">
    ...
    <section>
        ...
        <div class="prd-promo has-banner" style="background: #f2fbc2;" data-html-id="3109">
