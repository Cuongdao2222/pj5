...
@section('content') 
    ...
    <div class="banner-outer">
        <div class="banner-inner responsive-wrapper">
            <p class="text-promotion">Khuyến mãi 250k</p>
        </div>
    </div>
    <!-- flash sale --> 
    <div class="img-flashsale mobiles" style="width: 100%;"> <a href="http://localhost/pj5/deal"><img src="http://localhost/pj5/images/template/flashsalemb.jpg" style="width: 100%"></a> </div>
    <div class="title titles-time key0">
        <ul class="cat-child">
            <li onclick="clickDeal(1,3, 1)" class="deal1">
                <h3 class="actives-click active_3">
                    <span>14h</span> <br> 
                    <span>
                        <div class="clock"><span class="hour">01</span>:<span class="minutes">05</span>:<span class="second">43</span></div>
                    </span>
                </h3>
            </li>
            <li onclick="clickDeal(1,4, 2)" class="deal1">
                <h3 class=" active_4"> <span>17h</span> <br> <span>SẮP DIỄN RA</span> </h3>
            </li>
        </ul>
    </div>
                ...
                <div class="col-flash col-flash-2 active">
                    <div id="sync1S" class="slider-banner owl-carousel flash-sale-banner owl-loaded owl-drag">
                        <div class="owl-stage-outer">
                            <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 475px;">
                                <div class="owl-item active" style="width: 227.5px; margin-right: 10px;">
                                    <div class="item">
                                        <a href="http://localhost/pj5/may-giat-lg-fv1409s4w-inverter-9-kg">
                                            <div class="img"> <img width="327" src="http://localhost/pj5/uploads/product/crawl/child/5584_wrwrwqr.jpg" data-src="http://localhost/pj5/uploads/product/crawl/child/5584_wrwrwqr.jpg" title="Máy giặt LG FV1409S4W inverter 9 kg"> </div>
                                        </a>
                                        <div class="desc desc-deal0">
                                            <a href="http://localhost/pj5/may-giat-lg-fv1409s4w-inverter-9-kg">
                                                <h4 class="title">Máy giặt LG FV1409S4W inverter 9 kg</h4>
                                                <div class="container-price">
                                                    <div> <span class="price-old">9.190.000₫</span> </div>
                                                </div>
                                                <div style="margin-top: 11px"> <span class="price-new">250.000₫</span> </div>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="owl-item active" style="width: 227.5px; margin-right: 10px;">
                                    <div class="item">
                                        <a href="http://localhost/pj5/dieu-hoa-lg-v10enw1-inverter-9000btu">
                                            <div class="img"> <img width="327" src="http://localhost/pj5/uploads/product/1654738999_L-01~1.jpg" data-src="http://localhost/pj5/uploads/product/1654738999_L-01~1.jpg" title="Điều hòa LG V10ENW1 1 chiều inverter 9000BTU"> </div>
                                        </a>
                                        <div class="desc desc-deal1">
                                            <a href="http://localhost/pj5/dieu-hoa-lg-v10enw1-inverter-9000btu">
                                                <h4 class="title">Điều hòa LG V10ENW1 1 chiều inverter 9000BTU</h4>
                                                <div class="container-price">
                                                    <div> <span class="price-old">7.270.000₫</span> </div>
                                                </div>
                                                <div style="margin-top: 11px"> <span class="price-new">250.000₫</span> </div>
                                            </a>
                                        </div>
                        ...
                        <div class="owl-nav disabled">
                            ...
                            <div class="owl-next disabled"><i class="fa fa fa-angle-right"></i></div>
                        </div>
