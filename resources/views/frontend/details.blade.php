...
@push('style')
    ...
    @endif
    <link rel="stylesheet" type="text/css" href="{{ asset('css/detail1fe.css') }}?ver=16">
    <style type="text/css">
        .copy-button{
            position: absolute;
...
<section data-id="235791" data-cate-id="1942" class="detail ">
 ...
 -->
            ...
            <div class="show-infomation-pd" style="height:230px; overflow: hidden;">
                {!!  $data->Specifications  !!} 
            </div>    
        ...
        <div class="box_right desktop">
            ...
            <div class="box-compare">
                ...
                @if(!empty($thuonghieu[$data_cate])&& !empty($ar_groups_info))
                <span style="font-weight: bold; font-size:17px ">Hãng: {{ str_replace($namecate->name, '',  $ar_groups_info[0]['name']) }}</span> 
                @endif
                &nbsp
