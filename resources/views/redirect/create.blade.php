    ...
    <div class="group">
        <div class="group-fields">
            ...
            <table id="tb_padding">
                <tbody><tr>
                    <td>Link cũ</td>
                    <td><input type="text" size="80" name="info[request_path]" id="request_path" value="/dieu-hoa-daikin-ftkc71uvmv-1-chieu-inverter-24200btu/"></td>
                </tr>
                <tr>
                    <td>Link đích mới</td>
                    <td><input type="text" size="80" name="info[target_path]" id="target_path" value="https://dienmaynguoiviet.vn/dieu-hoa-daikin-ftkc71uvmv-1-chieu-inverter-24000btu/"></td>
                </tr>
                <tr>
                    <td>Redirect Code</td>
