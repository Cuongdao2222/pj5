...
class indexController extends Controller
{
    public function index()
    {
        ...
        $product_sale = Cache::rememberForever('product_sale', function() {
            ...
            $product_sale = DB::table('products')->join('sale_product', 'products.id', '=', 'sale_product.product_id')->join('makers', 'products.Maker', '=', 'makers.id')->Orderby('sale_product.updated_at','desc')->take(20)->get();
