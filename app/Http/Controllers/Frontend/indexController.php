...
class indexController extends Controller
{
    public function index()
    {
        ...
        $product_sale = Cache::rememberForever('product_sale', function(){
            ...
            $product_sales = DB::table('products')->join('sale_product', 'products.id', '=', 'sale_product.product_id')->join('makers', 'products.Maker', '=', 'makers.id')->Orderby('products.sale_order','desc')->take(15)->get();
